    ...
    console.log(date);                                                                                                                                                                                                                                                                                                                                                         
     return (
        ...
        <div className='flex mb-2 pl-7 pr-8 text-xl font-extralight justify-between border-b-2 border-bkg-1'>
          <h2 className='hover:bg-accent-1 p-1 rounded-md border border-bkg-2 active:border active:border-accent-2 active:p-1 hover:cursor-pointer' >January</h2>
          <h2 className='text-sm mt-3'>week 1</h2>
            ...
            <div className=" flex flex-col items-center">
                ...
                <h1 className='hover:bg-accent-1 border-2 border-transparent rounded-lg active:border-accent-2 cursor-pointer flex justify-center text-2xl font-thin mt-5 p-2 w-1/5' >
                    2024
                </h1>
            </div>
</div>
